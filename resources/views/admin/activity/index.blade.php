...
<div class="panel-header bg-primary-gradient">
    <div class="page-inner py-5">
        <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
            <div>
                <h2 class="text-white pb-2 fw-bold">Activity</h2>
            ...
            <div class="card full-height">
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="table-activity" class="display table table-striped table-hover">
                            <thead>
                                <tr>
                                    <th>Judul</th>
                                    <th>Slug</th>
...
@include('admin.activity.modals.modal_activity')
@endsection
...
<script>
    $('#welcome-speech').submit(function(e){
        e.preventDefault();
            ...
            if ($('#btn').val() == 'simpan') {
                var url = "{{route('admin.activities.store')}}";
                var text = "Successfully Create Activity";
            }

            if ($('#btn').val() == 'update') {
                var url = "{{route('admin.update-activity')}}";
                var text = "Successfully Update Activity";
            }
        ...
        responsive: true,
            ...
            ajax: "{{ route('admin.activities.index') }}",
                ...
                "render": function (data, type, row, meta) {
                        return' <a href="{{url("admin/activities")}}/'+data+'/edit"class="btn btn-primary btn-sm  button-update" title="Edit" data-id='+data+'><i class="fa fa-edit"></i></a>  <a href="{{url("admin/activities")}}/'+data+'" class="btn btn-danger btn-sm delete-confirm" title="Hapus"><i class="fa fa-times"></i></a>'
                        },
                    },
            ]
    });
        ...
        var me = $(this),
            ...
            if(Delete){
                $.ajax({
                    ...
                    success: function(response){
                        $('#table-activity').DataTable().ajax.reload();
                        swal("Good job!", "Successfully Delete Activity", {
						icon : "success",
						buttons: {        			
							confirm: {
								className : 'btn btn-success'
